...
public class ClubFragment extends android.app.Fragment{
    ...
    protected ArrayList<PointOfInterest> poi_club;//pointofinterest;
    ...
    private void initDataset() throws MalformedURLException, JSONException, ExecutionException, InterruptedException {
        ...
        if (this.poi_club==null) {
            //DOWNLOAD DATA FROM WEB
            URL url = new URL("http://83.212.110.211:8080/city_guide_webservice/getPointOfInterest?subcategory=6");
            ...
            if (pointofinterest_string != null) {
                ...
                this.poi_club = jsonparse.parsePointofinterest(pointofinterest_string);
                ...
                if (sharedPrefs.getBoolean("prefSendReport", false)) {
                    this.poi_club = jsonparse.eucledianDistance(this.poi_club, this.getActivity());
                }/* else {
    ...
    private void fillAdapter()
    {
        ...
        this.mAdapter = new CustomAdapter(this.poi_club);
