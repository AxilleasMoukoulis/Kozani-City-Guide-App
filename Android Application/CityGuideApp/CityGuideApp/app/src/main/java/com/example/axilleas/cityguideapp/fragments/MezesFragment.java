...
public class MezesFragment extends android.app.Fragment{

    protected LayoutManagerType mCurrentLayoutManagerType;
    protected RecyclerView mRecyclerView;
    protected CustomAdapter mAdapter;
    protected RecyclerView.LayoutManager mLayoutManager;
    protected ArrayList<PointOfInterest> poi_mezes;//pointofinterest;
    ...
    private void initDataset() throws MalformedURLException, JSONException, ExecutionException, InterruptedException {
        ...
        if (this.poi_mezes==null) {
            //DOWNLOAD DATA FROM WEB
            URL url = new URL("http://83.212.110.211:8080/city_guide_webservice/getPointOfInterest?subcategory=9");
            ...
            if (pointofinterest_string != null) {
                ...
                this.poi_mezes = jsonparse.parsePointofinterest(pointofinterest_string);
                ...
                if (sharedPrefs.getBoolean("prefSendReport", false)) {
                    this.poi_mezes = jsonparse.eucledianDistance(this.poi_mezes, this.getActivity());
                }/* else {
    ...
    private void fillAdapter()
    {
        ...
        this.mAdapter = new CustomAdapter(this.poi_mezes);
